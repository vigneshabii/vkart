...
return(
        <Fragment>
        {items.length === 0 ? 
            <h2 className="mt-5"><b>Your cart is empty</b></h2>
        :
        <Fragment>
        ...
        <div className="row d-flex justify-content-between">
                    ...
                    <div className="row">
                        ...
                        <div className="col-4 col-lg-3 mt-4 mt-lg-0">
                            <div className="stockCounter d-inline">
								...
								<span className="btn btn-primary plus" onClick={()=> increasQty(item)}>+</span>
                            </div>
                        </div>
            ...
            <div className="col-12 col-lg-3 my-4">
                <div id="order_summary">
                    ...
                    <p>Est. total: <span className="order-summary-values">${Math.round(items.reduce((acc, item)=>(acc +  item.quantity * item.price), 0))}</span></p>
